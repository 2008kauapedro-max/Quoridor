...
export const SKIN_CATALOG = [
  ...
  /* 🌍 PAÍSES */
  { id:"p-brasil",     cat:"piece", name:"Brasil",     swatch:["#22c55e","#facc15"], ...P("brasil","#009c3b","#002776",118,"repeating-linear-gradient(45deg,#009c3b 0 8px,#ffdf00 8px 11px,#002776 11px 19px)"), unlock:{desc:"Vença 1 partida.",cur:s=>s.wins,target:1} },
  { id:"p-argentina",  cat:"piece", name:"Argentina",  swatch:["#7dd3fc","#ffffff"], ...P("argentina","#74acdf","#f6b40e",118,"repeating-linear-gradient(45deg,#74acdf 0 8px,#ffffff 8px 16px,#f6b40e 16px 19px)"), unlock:{desc:"Vença 2 partidas.",cur:s=>s.wins,target:2} },
  { id:"p-alemanha",   cat:"piece", name:"Alemanha",   swatch:["#111111","#facc15"], ...P("alemanha","#dd0000","#ffce00",240,"repeating-linear-gradient(45deg,#000000 0 8px,#dd0000 8px 16px,#ffce00 16px 24px)"), unlock:{desc:"Vença 3 partidas.",cur:s=>s.wins,target:3} },
  { id:"p-franca",     cat:"piece", name:"França",     swatch:["#2563eb","#ef4444"], ...P("franca","#0055a4","#ef4135",140,"repeating-linear-gradient(45deg,#0055a4 0 8px,#ffffff 8px 16px,#ef4135 16px 24px)"), unlock:{desc:"Vença 1 partida online.",cur:s=>s.onlineWins||0,target:1} },
  { id:"p-holanda",    cat:"piece", name:"Holanda",    swatch:["#f97316","#2563eb"], ...P("holanda","#ae1c28","#21468b",125,"repeating-linear-gradient(45deg,#ae1c28 0 8px,#ffffff 8px 16px,#21468b 16px 24px)"), unlock:{desc:"Vença 2 partidas online.",cur:s=>s.onlineWins||0,target:2} },
  { id:"p-inglaterra", cat:"piece", name:"Inglaterra", swatch:["#ffffff","#dc2626"], ...P("inglaterra","#ce1124","#ffffff",125,"repeating-linear-gradient(45deg,#ffffff 0 8px,#ce1124 8px 16px)"), unlock:{desc:"Alcance o nível 3.",cur:(s,l)=>l,target:3} },
  { id:"p-paraguai",   cat:"piece", name:"Paraguai",   swatch:["#dc2626","#2563eb"], ...P("paraguai","#d52b1e","#0038a8",180,"repeating-linear-gradient(45deg,#d52b1e 0 8px,#ffffff 8px 16px,#0038a8 16px 24px)"), unlock:{desc:"Vença 1 partida vs IA.",cur:s=>s.wins,target:1} },
  { id:"p-portugal",   cat:"piece", name:"Portugal",   swatch:["#16a34a","#dc2626"], ...P("portugal","#046a38","#da291c",115,"repeating-linear-gradient(45deg,#046a38 0 8px,#da291c 8px 16px)"), unlock:{desc:"Sequência de 2 vitórias.",cur:s=>s.bestWinStreak,target:2} },

  /* ⚽ TIMES */
  { id:"p-flamengo", cat:"piece", name:"Flamengo", swatch:["#c8102e","#000000"], ...P("flamengo","#c8102e","#000000",160,"repeating-linear-gradient(45deg,#c8102e 0 8px,#000000 8px 16px)"), unlock:{desc:"Vença 1 partida.",cur:s=>s.wins,target:1} },
  { id:"p-vasco",    cat:"piece", name:"Vasco",    swatch:["#000000","#ffffff"], ...P("vasco","#3a3a3a","#000000",145,"repeating-linear-gradient(45deg,#000000 0 8px,#ffffff 8px 16px)"), unlock:{desc:"Vença 2 partidas.",cur:s=>s.wins,target:2} },
  { id:"p-paysandu", cat:"piece", name:"Paysandu", swatch:["#003da5","#ffffff"], ...P("paysandu","#003da5","#00205b",165,"repeating-linear-gradient(45deg,#003da5 0 8px,#ffffff 8px 16px)"), unlock:{desc:"Alcance o nível 2.",cur:(s,l)=>l,target:2} },
