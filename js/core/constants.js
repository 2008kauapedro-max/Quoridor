...
export const SKIN_CATALOG = [
  ...
  /* ⚽ TIMES */
  { id:"p-bolacopa", cat:"piece", sub:"time", name:"Bola Copa", swatch:["#f8fafc","#0f172a"], free:true, ...P("bolacopa","#e2e8f0","#0f172a",140,"repeating-linear-gradient(45deg,#009c3b 0 8px,#ffdf00 8px 16px)") },
