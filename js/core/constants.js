...
export const SKIN_CATALOG = [
  ...
  { id:"p-alemanha",   cat:"piece", name:"Alemanha",   swatch:["#111111","#facc15"], ...P("alemanha","#dd0000","#ffce00",200,"repeating-linear-gradient(45deg,#000000 0 8px,#dd0000 8px 16px,#ffce00 16px 24px)"), unlock:{desc:"Vença 3 partidas.",cur:s=>s.wins,target:3} },
