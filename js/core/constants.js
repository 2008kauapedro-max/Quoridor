...
export const SKIN_CATALOG = [
  ...
  /* ⚽ TIMES */
  { id:"p-flamengo", cat:"piece", name:"Flamengo", swatch:["#c8102e","#000000"], img:"img/flags/flamengo.png", badge:F("flamengo"), wall:"repeating-linear-gradient(45deg,#c8102e 0 8px,#000000 8px 16px)", unlock:{desc:"Vença 1 partida.",cur:s=>s.wins,target:1} },
  { id:"p-vasco",    cat:"piece", name:"Vasco",    swatch:["#000000","#ffffff"], img:"img/flags/vasco.png",    badge:F("vasco"),    wall:"repeating-linear-gradient(45deg,#000000 0 8px,#ffffff 8px 16px)", unlock:{desc:"Vença 2 partidas.",cur:s=>s.wins,target:2} },
    { id:"p-paysandu", cat:"piece", name:"Paysandu", swatch:["#003da5","#ffffff"], img:"img/flags/paysandu.png", badge:F("paysandu"), wall:"repeating-linear-gradient(45deg,#003da5 0 8px,#ffffff 8px 16px)", unlock:{desc:"Alcance o nível 2.",cur:(s,l)=>l,target:2} },
