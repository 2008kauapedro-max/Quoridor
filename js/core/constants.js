...
export const SKIN_CATALOG = [
  ...
  { id:"p-alemanha",   cat:"piece", name:"Alemanha",   swatch:["#111111","#facc15"], ...P("alemanha","#dd0000","#ffce00",140,"repeating-linear-gradient(45deg,#000000 0 8px,#dd0000 8px 16px,#ffce00 16px 24px)"), unlock:{desc:"Vença 3 partidas.",cur:s=>s.wins,target:3} },
  ...
  { id:"p-paraguai",   cat:"piece", name:"Paraguai",   swatch:["#dc2626","#2563eb"], ...P("paraguai","#d52b1e","#0038a8",125,"repeating-linear-gradient(45deg,#d52b1e 0 8px,#ffffff 8px 16px,#0038a8 16px 24px)"), unlock:{desc:"Vença 1 partida vs IA.",cur:s=>s.wins,target:1} },
  ...
  { id:"p-paysandu", cat:"piece", name:"Paysandu", swatch:["#003da5","#ffffff"], ...P("paysandu","#003da5","#00205b",150,"repeating-linear-gradient(45deg,#003da5 0 8px,#ffffff 8px 16px)"), unlock:{desc:"Alcance o nível 2.",cur:(s,l)=>l,target:2} },
